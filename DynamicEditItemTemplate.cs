...
namespace NewMCIS
{
	public class DynamicItemTemplate : ITemplate, INamingContainer, IBindableTemplate
	{
		ListItemType _type;
		...
		public DynamicItemTemplate(ListItemType type, DataColumnCollection dccol, bool showEdit)
		{
			_type = type;
			_dccol = dccol;
			ShowEdit = showEdit;
